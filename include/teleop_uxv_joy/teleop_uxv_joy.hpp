...
private:
  ...
  /* Node parameters. */
  bool                 actions_arm_as_topic_         = false;
  int64_t              actions_arm_index_            = 0;
  std::string          actions_arm_name_             = "";
  int64_t              actions_cooldown_             = 0;
  bool                 actions_disarm_as_topic_      = false;
  int64_t              actions_disarm_index_         = 0;
  std::string          actions_disarm_name_          = "";
  double               axes_filter_beta_             = 0.0;
  double               axes_filter_dcutoff_          = 0.0;
  bool                 axes_filter_enable_           = false;
  double               axes_filter_min_cutoff_       = 0.0;
  double               axes_filter_output_deadband_  = 0.0;
  double               axes_filter_settle_threshold_ = 0.0;
  double               axes_lh_deadzone_             = 0.0;
  int64_t              axes_lh_index_                = 0;
  bool                 axes_lh_normalize_round_      = false;
  bool                 axes_lh_reverse_              = false;
  double               axes_lh_scale_                = 0.0;
  double               axes_lv_deadzone_             = 0.0;
  int64_t              axes_lv_index_                = 0;
  bool                 axes_lv_normalize_round_      = false;
  bool                 axes_lv_reverse_              = false;
  double               axes_lv_scale_                = 0.0;
  double               axes_rh_deadzone_             = 0.0;
  int64_t              axes_rh_index_                = 0;
  bool                 axes_rh_normalize_round_      = false;
  bool                 axes_rh_reverse_              = false;
  double               axes_rh_scale_                = 0.0;
  double               axes_rv_deadzone_             = 0.0;
  int64_t              axes_rv_index_                = 0;
  bool                 axes_rv_normalize_round_      = false;
  bool                 axes_rv_reverse_              = false;
  double               axes_rv_scale_                = 0.0;
  int64_t              enable_button_index_          = 0;
  bool                 enable_button_require_        = false;
  std::string          frame_id_                     = "";
  bool                 gear_automatic_               = false;
  int64_t              gear_cooldown_                = 0;
  int64_t              gear_d_index_                 = 0;
  int64_t              gear_down_index_              = 0;
  int64_t              gear_n_index_                 = 0;
  int64_t              gear_r_index_                 = 0;
  int64_t              gear_up_index_                = 0;
  std::vector<int64_t> num_inputs_indexes_           = {};
  int64_t              services_cooldown_            = 0;
  bool                 services_kill_as_topic_       = false;
  int64_t              services_kill_index_          = 0;
  std::string          services_kill_name_           = "";
  bool                 services_reset_as_topic_      = false;
  int64_t              services_reset_index_         = 0;
  std::string          services_reset_name_          = "";
  bool                 uxv_command_arm_              = false;
  int64_t              uxv_command_mode_             = 0;
